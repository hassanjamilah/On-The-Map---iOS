...
struct  Student:Codable {
   ...
   """.data(using: .utf8)!
    ...
    static func getSharedAllStudents()->[Student]{
        let delegate = UIApplication.shared.delegate as! AppDelegate
        return delegate.allStudents
    }
    
    static func updateSharedAllStudents (students:[Student]){
        let delegate = UIApplication.shared.delegate as! AppDelegate
        delegate.allStudents = [Student]()
        delegate.allStudents = students
    }
